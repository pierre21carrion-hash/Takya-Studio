  ...
  return (
    <div>
      <div style={{ paddingBottom: 24, marginBottom: 32, borderBottom: '1px solid #D8D2C8' }}>
        <h1 style={{ fontFamily: 'var(--font-geist-sans)', fontSize: 34, fontWeight: 800, color: '#1C1714', letterSpacing: '-0.03em' }}>Notificaciones</h1>
      ...
      <div className="rounded-xl flex flex-col items-center justify-center" style={{ background: '#fff', border: '1px solid #D8D2C8', padding: '80px 40px', textAlign: 'center' }}>
        ...
        <div style={{ fontFamily: 'var(--font-geist-sans)', fontSize: 20, fontWeight: 700, color: '#3D3530', marginBottom: 8 }}>Módulo Notificaciones</div>
